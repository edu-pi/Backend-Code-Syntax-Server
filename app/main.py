...
from app.route.advice_router import router as advice_router
from app.route.syntax_router import router as syntax_router
...
app.include_router(syntax_router,  prefix="/edupi-syntax")
